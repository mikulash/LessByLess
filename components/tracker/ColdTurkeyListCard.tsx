      ...
      <View style={styles.progressContainer}>
          ...
          <View style={styles.streakSection}>
            ...
            {hasGoneLonger ? (
              <View style={styles.achievementRow}>
                ...
                <Text style={styles.achievementText}>Going longer than last time</Text>
              </View>
            ) : null}
          </View>
        ) : null}
        ...
        {shouldShowRecordProgress ? (
          <View style={styles.streakSection}>
            ...
            {hasHitRecord ? (
              <View style={styles.achievementRow}>
                <FontAwesome6 name="medal" size={12} color="#fde047" />
                <Text style={styles.achievementText}>Record time</Text>
              </View>
            ) : null}
          </View>
        ) : null}
